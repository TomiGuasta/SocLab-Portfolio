...
![Ejecución Intento 1](https://github.com/TomiGuasta/SocLab-Portfolio/blob/main/homelab-soc/docs/DVWA-Attacks/BruteForce/DVWA%20BruteForce%20-%20Hydra.png?raw=true)
...
![Ejecución Intento 2](https://github.com/TomiGuasta/SocLab-Portfolio/blob/main/homelab-soc/docs/DVWA-Attacks/BruteForce/DVWA%20BruteForce-%202nd%20Attack.png?raw=true)
...
![Ejecución Intento 3](https://github.com/TomiGuasta/SocLab-Portfolio/blob/main/homelab-soc/docs/DVWA-Attacks/BruteForce/DVWA%20BruteForce-%203rd%20Attack.png?raw=true)
...
1. **Intento 1 (Básico):** Se aprecia el alto volumen de peticiones y los falsos positivos detectados.
![Splunk Intento 1](https://github.com/TomiGuasta/SocLab-Portfolio/blob/main/homelab-soc/docs/DVWA-Attacks/BruteForce/Splunk%20-%20DVWA%20BruteForce%20FULL.png?raw=true)

2. **Intento 2 (Ajustado):** Se observa una reducción en el volumen de peticiones, pero aún persisten falsos positivos debido a la concurrencia.
![Splunk Intento 2](https://github.com/TomiGuasta/SocLab-Portfolio/blob/main/homelab-soc/docs/DVWA-Attacks/BruteForce/Splunk%202nd%20attack%20-%20DVWA%20BruteForce%20.png?raw=true)

3. **Intento 3 (Debug):** Con el ajuste final, el reporte de Splunk muestra un ataque limpio, sin falsos positivos, correlacionando con el resultado exitoso de Hydra.
![Splunk Intento 3](https://github.com/TomiGuasta/SocLab-Portfolio/blob/main/homelab-soc/docs/DVWA-Attacks/BruteForce/Splunk%203rd%20attack%20-%20DVWA%20BruteForce%20.png?raw=true)
