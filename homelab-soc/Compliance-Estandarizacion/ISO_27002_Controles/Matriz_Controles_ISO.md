...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **8.15** | Registro de eventos | Eventos de seguridad (logs) registrados, protegidos y revisados para detectar anomalías. | [SIEM](../../../homelab-soc/docs/) | `[Link a Logs]` | CISO / Lab Admin | En revisión |
| **8.16** | Monitoreo de actividades | Monitoreo de sistemas para detectar comportamiento inusual (ataques, acceso no autorizado). | [Nmap](../../../homelab-soc/docs/Nmap%20-%20PortScan/Playbook-Nmap.md) | `[Link a Alertas]` | CISO / Lab Admin | Implementado |
